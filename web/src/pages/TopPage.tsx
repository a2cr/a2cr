  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <header className="relative z-10 mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-4 sm:px-6">
        <Link to="/">
          <img src="/brand/a2cr-logo-dark-v2.png" alt="A2CR" className="h-8 w-auto object-contain" />
        </Link>
      ...
      <main>
        ...
        <section className="mx-auto max-w-7xl px-4 pb-24 pt-16 sm:px-6 sm:pt-28">
          <img src="/brand/a2cr-logo-dark-v2.png" alt="A2CR" className="mb-10 w-full max-w-[200px] object-contain" />
