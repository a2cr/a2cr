...
const resources = {
  en: {
    translation: {
      ...
      pricing: {
        title: "Pricing",
        subtitle: "Free public preview focuses on WorkBaton and WorkStash. Pro is planned for larger, longer-running AI work.",
        freeName: "Free",
        proName: "Pro",
        freePrice: "$0",
        proPrice: "$8 / month",
        freeNote: "Available in public preview",
        proNote: "Planned paid tier",
        slots: "Active slots",
        retention: "Retention",
        ...
        saves: "Saves",
        loads: "Loads",
        workBatonSaves: "WorkBaton saves",
        workBatonLoads: "WorkBaton loads",
        workStashWrites: "WorkStash writes",
        workStashReads: "WorkStash reads",
        logs: "Access logs",
        ...
        explainerTitle: "How to read these limits",
        explainWorkBatonTitle: "WorkBaton is the handoff",
        explainWorkBatonBody: "Slots hold compact checkpoints for resuming work. Save and load limits apply to those checkpoint operations.",
        explainWorkStashTitle: "WorkStash is supporting memory",
        explainWorkStashBody: "Storage is total encrypted temporary notes. Writes and reads are counted separately from WorkBaton saves and loads.",
        explainRateTitle: "Hourly limits are guardrails",
        explainRateBody: "The limits are intended to fit normal agent workflows while keeping the public preview predictable.",
        notesTitle: "Notes",
        notePublicPreview: "Free is for everyday serial handoff and early community feedback.",
        noteProPlanned: "Pro is not available yet; price and limits are planned before checkout is enabled.",
        noteNoSecrets: "Do not store secrets in WorkBaton or WorkStash. Use them for working state, not credentials."
      },
      errors: {
  ...
  ja: {
    translation: {
      ...
      pricing: {
        title: "料金",
        subtitle: "Free public preview は WorkBaton と WorkStash を中心に提供します。Pro は、より大きく長い AI 作業向けの予定プランです。",
        freeName: "Free",
        proName: "Pro",
        freePrice: "$0",
        proPrice: "$8 / 月",
        freeNote: "公開プレビューで利用可能",
        proNote: "予定している有料プラン",
        slots: "有効スロット",
        retention: "保存期間",
        body: "チェックポイントサイズ",
        ...
        saves: "保存",
        loads: "ロード",
        workBatonSaves: "WorkBaton 保存",
        workBatonLoads: "WorkBaton ロード",
        workStashWrites: "WorkStash 書き込み",
        workStashReads: "WorkStash 読み取り",
        logs: "アクセスログ",
        workthreads: "WorkThreads",
        ...
        planned: "近日公開",
        comingSoon: "近日公開",
        explainerTitle: "制限値の読み方",
        explainWorkBatonTitle: "WorkBaton は引き継ぎ",
        explainWorkBatonBody: "スロットには、作業を再開するための小さなチェックポイントを保存します。保存・ロード上限は、このチェックポイント操作に対する制限です。",
        explainWorkStashTitle: "WorkStash は補助メモ",
        explainWorkStashBody: "ストレージは暗号化された一時メモの合計容量です。書き込み・読み取りは WorkBaton の保存・ロードとは別に数えます。",
        explainRateTitle: "時間あたり上限は安全弁",
        explainRateBody: "通常の AI エージェント利用には足りる範囲を保ちつつ、公開プレビューを安定して運用するための上限です。",
        notesTitle: "補足",
        notePublicPreview: "Free は日常的な直列引き継ぎと、初期フィードバック向けです。",
        noteProPlanned: "Pro はまだ提供前です。価格と上限は、決済を有効化する前の予定値です。",
        noteNoSecrets: "WorkBaton / WorkStash に秘密情報は保存しないでください。認証情報ではなく、作業状態を保存する場所です。"
      },
      errors: {
