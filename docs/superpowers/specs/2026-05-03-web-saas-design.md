...
`default_retention_seconds` は新規保存時の保持期間を決める。Freeは15分/30分/1時間/3時間/6時間/12時間/24時間から選択でき、デフォルト兼上限は24時間。Proは15分/30分/1時間/3時間/6時間/12時間/24時間/3日/7日/10日/14日/30日から選択でき、デフォルト兼上限は30日。Proへ変更した直後は30日に設定するが、ユーザーが短命運用を望む場合は15分まで短くできる。
...
| `expires_at` | 選択した保持期間（15分/30分/1時間/3時間/6時間/12時間/24時間、デフォルト24時間） | 選択した保持期間（15分/30分/1時間/3時間/6時間/12時間/24時間/3日/7日/10日/14日/30日、デフォルト30日） |
...
- 保持期間設定（Freeは15分/30分/1時間/3時間/6時間/12時間/24時間、Proは15分/30分/1時間/3時間/6時間/12時間/24時間/3日/7日/10日/14日/30日）
...
| 料金 | Free | 5 USD/month |
| active slots | 3件 | 100件 |
| checkpoint保持 | 15分/30分/1時間/3時間/6時間/12時間/24時間（デフォルト24時間） | 15分/30分/1時間/3時間/6時間/12時間/24時間/3日/7日/10日/14日/30日（デフォルト30日） |
| checkpoint本文上限 | 32KB | 128KB |
