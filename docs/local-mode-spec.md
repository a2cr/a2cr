...
The baseline dashboard organization layer now makes the `Project` view
concrete: one selected project can show its WorkBaton, WorkStash, WorkThreads,
and recent events together. The first implementation filters client-side from
